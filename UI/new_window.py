...
class NewWindow(QMainWindow):
    ...
    #input_layout
        ...
        self.Ci_auto_checkbox = QCheckBox("ng/g",self)
        ...
        self.sample_mass_g_checkbox = QCheckBox("g/cm^2",self)
        self.sample_mass_mg_checkbox = QCheckBox("mg/cm^2",self)
        self.sample_mass_ug_checkbox = QCheckBox("ug/cm^2",self)
        self.sample_mass_ng_checkbox = QCheckBox("ng/cm^2",self)      
        ...
        self.element_mass_g_checkbox = QCheckBox("g/cm^2",self)
        self.element_mass_mg_checkbox = QCheckBox("mg/cm^2",self)
        self.element_mass_ug_checkbox = QCheckBox("ug/cm^2",self)
        self.element_mass_ng_checkbox = QCheckBox("ng/cm^2",self) 
        ...
        # #QLineEdit
        #self.pixel_size_label = QLabel("treshold [%]",self)
        ...
        Names_layout.addWidget(self.Treshold)
